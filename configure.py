...
try:
    ...
    envDataSetDIR = os.path.abspath(os.path.join(envDiplomaDIR, "..", "DataSet","Destination","Classification_Images"))
    envTestDataSetDIR = os.path.abspath(os.path.join(envDataSetDIR,"Test"))
    ...
    bash_data = writeEnvParam(bash_data,"DataSetDIR",envDataSetDIR)
    bashfile.seek(0)
